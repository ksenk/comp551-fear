...
# -*- coding: utf-8 -*-
"""
Created on Tue Nov 28 23:35:30 2017
...
# -*- coding: utf-8 -*-
"""
Created on Tue Nov 28 19:43:20 2017
@author: Admin
"""
...
class Agent():
    ...
    def build_network(self):
        model = Sequential()
        model.add(Convolution2D(32, (8, 8), subsample=(4, 4), activation='relu', input_shape=(STATE_LENGTH, FRAME_WIDTH, FRAME_HEIGHT), data_format = 'channels_first'))
        model.add(Convolution2D(64, (4, 4), subsample=(2, 2), activation='relu', data_format = 'channels_first'))
        model.add(Convolution2D(64, (3, 3), subsample=(1, 1), activation='relu', data_format = 'channels_first'))
        model.add(Flatten())
    ...
    def get_initial_state(self, observation, last_observation):
        ...
        processed_observation = np.uint8(resize(rgb2gray(processed_observation), (FRAME_WIDTH, FRAME_HEIGHT), mode='constant') * 255,mode = 'constant')
...
if TRAIN:  # Train mode
    ...
    for num_ep in range(NUM_EPISODES):
        ...
        if life_count == None: life_count=0 #KSENIACODE
        else: life_count = info["ale.lives"]
